...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", "-p", type=str, default="/Users/rcross/Desktop/作业/Python/seq2seq-QA/dataset/", help="dataset path")
    parser.add_argument("--log_dir", type=str, default="logs/", help="dataset path")
    parser.add_argument("--model_data", type=str, default="/Users/rcross/Desktop/作业/Python/seq2seq-QA/model_data", help="mode output path")
    parser.add_argument("--dataset", "-n", type=str, default="xiaohuangji50w_nofenci", help="Train or Serve")
